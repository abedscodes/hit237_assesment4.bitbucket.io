# Generated by Django 4.2.13 on 2024-05-29 07:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_approved', models.BooleanField(default=False)),
                ('email', models.EmailField(max_length=254)),
                ('supervisors', models.ManyToManyField(to='proj_app.supervisor')),
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='proj_app.topic')),
            ],
        ),
        migrations.CreateModel(
            name='Application',
